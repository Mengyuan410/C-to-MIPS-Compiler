#ifndef LessThanEqualToOperator_hpp
#define LessThanEqualToOperato_hpp

#include "ast/Node.hpp"
#include "ast/Context.hpp"

class LessThanEqualToOperator : public Node
{
public:
  // Constructors
   LessThanEqualToOperator(NodePtr Left, NodePtr Right);

  // Destructor
  virtual ~ LessThanEqualToOperator();
