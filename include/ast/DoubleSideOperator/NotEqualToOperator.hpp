#ifndef NotEqualToOperator_hpp
#define NotEqualToOperator_hpp

#include "ast/Node.hpp"
#include "ast/Context.hpp"

class NotEqualToOperator : public Node
{
public:
  // Constructors
  NotEqualToOperator(NodePtr Left, NodePtr Right);

  // Destructor
  virtual ~NotEqualToOperator();
